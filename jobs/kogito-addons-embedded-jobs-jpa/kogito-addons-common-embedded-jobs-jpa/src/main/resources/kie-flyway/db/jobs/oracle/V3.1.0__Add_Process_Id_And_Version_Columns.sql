...
ALTER TABLE job_details ADD process_id VARCHAR2(255);
ALTER TABLE job_details ADD root_process_id VARCHAR2(255);
ALTER TABLE job_details ADD process_version VARCHAR2(255);
ALTER TABLE job_details ADD root_process_version VARCHAR2(255);
