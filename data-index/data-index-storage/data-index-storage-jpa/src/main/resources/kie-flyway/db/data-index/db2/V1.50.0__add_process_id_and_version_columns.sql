...
ALTER TABLE processes ADD COLUMN root_process_version VARCHAR(255);
ALTER TABLE jobs ADD COLUMN process_version VARCHAR(255);
ALTER TABLE jobs ADD COLUMN root_process_version VARCHAR(255);
ALTER TABLE tasks ADD COLUMN process_version VARCHAR(255);
ALTER TABLE tasks ADD COLUMN root_process_version VARCHAR(255);
